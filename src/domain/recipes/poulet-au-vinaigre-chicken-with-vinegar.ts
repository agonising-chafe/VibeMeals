// Generated by scripts/spoonacular-workflow.ts on 2025-12-11T21:45:23.106Z
...
export const pouletAuVinaigreChickenWithVinegar = {
  id: "atk_poulet-au-vinaigre-chicken-with-vinegar",
  name: "Poulet au Vinaigre (Chicken with Vinegar)",
  slug: "poulet-au-vinaigre-chicken-with-vinegar",
  metadata: {
    timeBand: "NORMAL",
    estimatedMinutes: 90,
    equipmentTags: [
