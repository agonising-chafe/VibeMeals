// Generated by scripts/spoonacular-workflow.ts on 2025-12-11T21:45:23.729Z
...
export const rusticDinnerRolls = {
  id: "atk_rustic-dinner-rolls",
  name: "Rustic Dinner Rolls",
  slug: "rustic-dinner-rolls",
  metadata: {
    timeBand: "PROJECT",
    estimatedMinutes: 210,
    leftoverStrategy: "EXPECTED",
    yieldText: "MAKES 16 rolls",
    baseServings: 16,
    equipmentTags: []
  },
  scalable: true,
  ingredients: [
    {
          ingredientId: "plus-1-tablespoon-water-at-room-temperature",
          displayName: "plus 1 tablespoon water, at room temperature",
          amount: 1.5,
          unit: "CUP",
    ...
    {
          ingredientId: "plus-1-tablespoon-161-2-ounces-bread-flour-plus-extra-for-the-dough-and-work-surface",
          displayName: "plus 1 tablespoon (161/2 ounces) bread flour, plus extra for the dough and work surface",
          amount: 3,
          unit: "CUP",
          criticality: "CRITICAL",
          kind: "CARB",
  ...
  preflight: [
    {
          label: "Proof dough",
          description: "The dough needs to rise for approximately 2 hours total, split into 1 hour, 30 minutes, and 30 minutes, before shaping into rolls.",
