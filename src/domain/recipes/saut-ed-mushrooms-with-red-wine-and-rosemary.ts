// Generated by scripts/spoonacular-workflow.ts on 2025-12-11T21:45:23.844Z
...
export const sautEdMushroomsWithRedWineAndRosemary = {
  id: "atk_saut-ed-mushrooms-with-red-wine-and-rosemary",
  name: "Sautéed Mushrooms with Red Wine and Rosemary",
  slug: "saut-ed-mushrooms-with-red-wine-and-rosemary",
  metadata: {
    timeBand: "FAST",
    estimatedMinutes: 30,
    equipmentTags: [
